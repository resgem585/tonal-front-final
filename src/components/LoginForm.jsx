...
<section className="min-h-screen flex items-stretch text-white ">
  <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: 'url(https://www.mexicodesconocido.com.mx/sites/default/files/nodes/inline/piedra-del-sol.gif)'}}>
