const HomeCards = () => {
  ...
  <img
    alt="Developer"
    src= 'https://www.playasmexico.mx/IMG/arton11246.jpg'
...
<a href="/temazcal" className="group relative block bg-black">
  <img
    alt="Developer"
    src="https://cms.lasestacas.com/sites/default/files/styles/tk_microsite_front_image/public/blog/1642723735054_1_0.jpg?itok=pgvar1hi"
    className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
  />
